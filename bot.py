...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("👋 أدخل عدد الريتيكولوسيت في Champ 1:")
    return RETI
...
async def get_reti(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("⚠️ أدخل رقم صحيح موجب")
        return RETI
    ...
    if len(data["reti"]) < 10:
        ...
        await update.message.reply_text("الآن أدخل عدد الكريات الحمراء في ربع Champ 1:")
        return RBC
